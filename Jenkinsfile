    ...
    stages{
        stage("checkout-SCM"){
            steps{
                ...
                url: 'https://github.com/HariReddy910/spring-petclinic1.git']]])
        ...
        stage("Deployment-AppServer"){
            steps{
              echo "hi"
             sh label: '', script: 'scp /var/lib/jenkins/workspace/petclinic/target/app.war ubuntu@172.31.41.179:/home/ubuntu/appserver/webapps/petclinic.war'
           }
        }
